...
export default function SongViewer({ song }: { song: SongDetail }) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const okKey = json.data.originalKey ?? originalKey;
      setOriginalKey(okKey);

      // atualiza snapshot
      setSnapshot(JSON.stringify({ parts: partsBase, originalKey: okKey }));
  ...
  function goCulto() {
    // vai para /songs/[id]/culto
    router.push(`/songs/${song.id}/culto`);
  }
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              title="Visual (voltar ao tom salvo)"
            >
              0
            </button>
